...
1. **超长标题**：平均 51.5 字，75% 超过 40 字
2. **情绪炸弹**：大量使用感叹号（23%）和情绪词
3. **多事件合并**：一个标题常包含 2-3 条新闻
4. **AI 日报格式**：59.5% 的标题带 "| AI日报MMDD" 后缀
5. **主导风格**：「情感式」占比 41.4%
...
**情绪词（必用）**：
引爆、大地震、核弹、重磅、史诗级、全面、吓出癫痫、雪崩、命运大转折、奇点、杀疯了、炸裂、瘫坐、见证历史、硝烟弥漫

**AI 领域词**：
AI、模型、DeepSeek、OpenAI、发布、Gemini、GPT、Anthropic、硅谷、Qwen、Claude、Google、泄露、上线、Kimi

**高频词 Top 20**：
AI日报(68)、模型(32)、DeepSeek(28)、OpenAI(22)、AI(20)、AI圈(18)、Gemini(17)、引爆(16)、Anthropic(12)、3.5(11)、硅谷(11)、来袭(10)、Google(9)、泄露(9)、Claude(9)、奥特曼(8)、深夜(8)、Mythos(8)、GPT-5.6(7)、核弹(7)
...
- 标题变长：从 2026-02 的 42.3 字 → 2026-06 的 60.2 字
- 情绪升级：强度从 2 → 5.1
- 最新高频情绪词：引爆
