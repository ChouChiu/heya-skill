...
1. **超长标题**：平均 52.7 字，80.6% 超过 40 字
2. **情绪炸弹**：大量使用感叹号（21%）和情绪词
3. **多事件合并**：一个标题常包含 2-3 条新闻
4. **AI 日报格式**：62% 的标题带 "| AI日报MMDD" 后缀
5. **主导风格**：「情感式」占比 45.4%
6. **独特词汇**：引爆、大地震、重磅、吓出癫痫、瘫坐、杀疯了、核弹、雪崩、头皮发麻、全面
...
**情绪词（必用）**：
引爆、大地震、重磅、吓出癫痫、瘫坐、杀疯了、核弹、雪崩、头皮发麻、全面、海啸、沸腾、硝烟弥漫、命运大转折、史诗级

**AI 领域词**：
AI、模型、DeepSeek、OpenAI、发布、Gemini、GPT、硅谷、泄露、Anthropic、Claude、Kimi、Qwen、上线、MiniMax

**高频词 Top 20**：
AI日报(67)、模型(34)、DeepSeek(30)、AI(22)、OpenAI(21)、Gemini(16)、AI圈(15)、引爆(14)、硅谷(10)、泄露(10)、Anthropic(9)、奥特曼(9)、来袭(8)、Kimi(8)、AI圈大地震(8)、Claude(8)、深夜(8)、MiniMax(7)、Mythos(7)、彻底(7)
...
`agent`、`pro`、`seedance`、`ceo`、`lite`、`studio`、`app`、`cursor`、`spud`、`gemma`

**情绪词常用搭配**：

- **引爆** 常搭配：深夜、AI圈、AI日报、模型、硅谷
- **大地震** 常搭配：AI圈大地震、AI日报、大地震、Kimi、深夜
- **重磅** 常搭配：重磅炸弹、AI日报、AI圈大地震、深夜、Kimi
- **头皮发麻** 常搭配：头皮发麻、AI、AI日报、Agent、字节
- **全面** 常搭配：全面、硅谷、AI日报、OpenAI、雪崩
- **核弹** 常搭配：核弹、AI圈、AI日报、DeepSeek、模型

**风格演变趋势**：

- 标题变长：从 2026-02 的 42.3 字 → 2026-06 的 60.6 字
- 情绪升级：强度从 2 → 5.9
- 最新高频情绪词：引爆
