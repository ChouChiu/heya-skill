...
1. **超长标题**：平均 51 字，75.4% 超过 40 字
2. **情绪炸弹**：大量使用感叹号（23%）和情绪词
3. **多事件合并**：一个标题常包含 2-3 条新闻
4. **AI 日报格式**：58.5% 的标题带 "| AI日报MMDD" 后缀
5. **主导风格**：「情感式」占比 41.5%
6. **独特词汇**：引爆、大地震、核弹、重磅、史诗级、全面、吓出癫痫、雪崩、命运大转折、斩杀线
7. **多分句结构**：平均 4.3 个分句，信息密度极高
8. **感叹号密度**：平均每标题 1.9 个感叹号
9. **最常用公式**：`{事件们} | AI日报{日期}`（69次）
10. **交叉风格**：「情感式」含交叉匹配 99 次（83.9%），标题常兼具多种风格
...
**情绪词（必用）**：
引爆、大地震、核弹、重磅、史诗级、全面、吓出癫痫、雪崩、命运大转折、斩杀线、奇点、杀疯了、炸裂、瘫坐、见证历史

**AI 领域词**：
AI、模型、DeepSeek、OpenAI、发布、Gemini、GPT、Anthropic、硅谷、Qwen、Claude、Google、泄露、开源、Kimi

**高频词 Top 20**：
AI日报(68)、模型(32)、DeepSeek(28)、OpenAI(22)、AI(20)、AI圈(17)、Gemini(17)、引爆(17)、Anthropic(12)、硅谷(12)、3.5(11)、来袭(10)、Google(9)、泄露(9)、Claude(9)、AI圈大地震(8)、开源(8)、核弹(8)、V4(8)、奥特曼(8)
...
`codex`、`ceo`、`studio`、`app`、`cursor`、`spud`、`k3`、`pony`、`siri`、`lite`

**情绪词常用搭配**：

- **引爆** 常搭配：深夜、AI日报、AI圈、核弹、硅谷
- **大地震** 常搭配：AI圈大地震、AI日报、大地震、深夜、DeepSeek
- **核弹** 常搭配：核弹、AI日报、AI圈、DeepSeek、模型
- **重磅** 常搭配：重磅炸弹、AI日报、AI圈大地震、Kimi、硅谷
