...
1. **超长标题**：平均 51.1 字，75.6% 超过 40 字
2. **情绪炸弹**：大量使用感叹号（24%）和情绪词
3. **多事件合并**：一个标题常包含 2-3 条新闻
4. **AI 日报格式**：58% 的标题带 "| AI日报MMDD" 后缀
5. **主导风格**：「情感式」占比 41.2%
6. **独特词汇**：引爆、大地震、核弹、重磅、史诗级、斩杀线、瘫坐、全面、吓出癫痫、雪崩
7. **多分句结构**：平均 4.3 个分句，信息密度极高
8. **感叹号密度**：平均每标题 1.9 个感叹号
9. **最常用公式**：`{事件们} | AI日报{日期}`（69次）
10. **交叉风格**：「情感式」含交叉匹配 100 次（84.0%），标题常兼具多种风格
...
**情绪词（必用）**：
引爆、大地震、核弹、重磅、史诗级、斩杀线、瘫坐、全面、吓出癫痫、雪崩、命运大转折、奇点、杀疯了、炸裂、见证历史

**AI 领域词**：
AI、模型、DeepSeek、OpenAI、发布、Gemini、GPT、Anthropic、硅谷、Qwen、Claude、Google、泄露、开源、Kimi

**高频词 Top 20**：
AI日报(68)、模型(32)、DeepSeek(28)、OpenAI(21)、AI(20)、AI圈(18)、引爆(18)、Gemini(17)、Anthropic(13)、3.5(11)、硅谷(11)、来袭(10)、深夜(9)、Google(9)、泄露(9)、Claude(9)、AI圈大地震(8)、开源(8)、核弹(8)、V4(8)
...
`codex`、`ceo`、`studio`、`app`、`spud`、`k3`、`pony`、`siri`、`lite`、`wc`

**情绪词常用搭配**：

- **引爆** 常搭配：深夜、AI圈、AI日报、核弹、硅谷
...
- 标题变长：从 2026-02 的 42.3 字 → 2026-06 的 60.1 字
- 情绪升级：强度从 2 → 5
- 最新高频情绪词：核弹
