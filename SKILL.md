...
1. **超长标题**：平均 52.2 字，79.6% 超过 40 字
2. **情绪炸弹**：大量使用感叹号（22%）和情绪词
3. **多事件合并**：一个标题常包含 2-3 条新闻
4. **AI 日报格式**：60.2% 的标题带 "| AI日报MMDD" 后缀
5. **主导风格**：「情感式」占比 43.7%
6. **独特词汇**：大地震、引爆、重磅、杀疯了、雪崩、吓出癫痫、头皮发麻、全面、海啸、瘫坐
7. **多分句结构**：平均 4.6 个分句，信息密度极高
8. **感叹号密度**：平均每标题 2.1 个感叹号
9. **最常用公式**：`{事件们} | AI日报{日期}`（62次）
10. **交叉风格**：「情感式」含交叉匹配 90 次（87.4%），标题常兼具多种风格
...
**情绪词（必用）**：
大地震、引爆、重磅、杀疯了、雪崩、吓出癫痫、头皮发麻、全面、海啸、瘫坐、命运大转折、史诗级、斩杀线、后背发凉、奇点

**AI 领域词**：
AI、DeepSeek、模型、OpenAI、Gemini、发布、GPT、Claude、泄露、硅谷、Qwen、上线、Anthropic、Kimi、Agent

**高频词 Top 20**：
AI日报(62)、模型(33)、DeepSeek(30)、AI(21)、OpenAI(19)、Gemini(16)、AI圈(12)、引爆(12)、奥特曼(9)、泄露(9)、硅谷(9)、Claude(8)、深夜(8)、Anthropic(7)、彻底(7)、人类(7)、来袭(7)、AI圈大地震(7)、V4(7)、重磅炸弹(6)
...
- 标题变长：从 2026-02 的 42.3 字 → 2026-06 的 59 字
- 情绪升级：强度从 2 → 5.7
- 最新高频情绪词：大地震
