...
1. **超长标题**：平均 51.5 字，75.4% 超过 40 字
2. **情绪炸弹**：大量使用感叹号（23%）和情绪词
3. **多事件合并**：一个标题常包含 2-3 条新闻
4. **AI 日报格式**：58.8% 的标题带 "| AI日报MMDD" 后缀
5. **主导风格**：「情感式」占比 40.4%
6. **独特词汇**：引爆、大地震、核弹、重磅、吓出癫痫、史诗级、见证历史、头皮发麻、全面、雪崩
7. **多分句结构**：平均 4.4 个分句，信息密度极高
8. **感叹号密度**：平均每标题 1.9 个感叹号
9. **最常用公式**：`{事件们} | AI日报{日期}`（67次）
10. **交叉风格**：「情感式」含交叉匹配 95 次（83.3%），标题常兼具多种风格
...
**情绪词（必用）**：
引爆、大地震、核弹、重磅、吓出癫痫、史诗级、见证历史、头皮发麻、全面、雪崩、杀疯了、炸裂、瘫坐、硝烟弥漫、命运大转折

**AI 领域词**：
AI、模型、DeepSeek、OpenAI、发布、Gemini、GPT、Anthropic、硅谷、Qwen、Claude、Google、泄露、Agent、上线

**高频词 Top 20**：
AI日报(66)、模型(31)、DeepSeek(28)、AI(21)、OpenAI(20)、Gemini(17)、引爆(16)、AI圈(15)、Anthropic(12)、硅谷(11)、3.5(10)、来袭(10)、Google(9)、泄露(9)、Claude(9)、Agent(8)、深夜(8)、Mythos(8)、奥特曼(8)、Qwen(7)
