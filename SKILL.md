...
1. **超长标题**：平均 50.7 字，76.1% 超过 40 字
2. **情绪炸弹**：大量使用感叹号（24%）和情绪词
3. **多事件合并**：一个标题常包含 2-3 条新闻
4. **AI 日报格式**：58.1% 的标题带 "| AI日报MMDD" 后缀
5. **主导风格**：「情感式」占比 43.6%
6. **独特词汇**：大地震、引爆、重磅、史诗级、杀疯了、雪崩、命运大转折、吓出癫痫、头皮发麻、奇点
7. **多分句结构**：平均 4.5 个分句，信息密度极高
8. **感叹号密度**：平均每标题 2 个感叹号
9. **最常用公式**：`{事件们} | AI日报{日期}`（68次）
10. **交叉风格**：「情感式」含交叉匹配 102 次（87.2%），标题常兼具多种风格
...
**情绪词（必用）**：
大地震、引爆、重磅、史诗级、杀疯了、雪崩、命运大转折、吓出癫痫、头皮发麻、奇点、全面、海啸、炸裂、斩杀线、后背发凉

**AI 领域词**：
AI、DeepSeek、模型、OpenAI、Gemini、发布、GPT、泄露、Claude、硅谷、Qwen、上线、Kimi、Anthropic、Agent

**高频词 Top 20**：
AI日报(68)、模型(36)、DeepSeek(33)、AI(22)、OpenAI(20)、Gemini(18)、AI圈(12)、引爆(12)、泄露(11)、硅谷(10)、奥特曼(9)、Claude(9)、来袭(9)、AI圈大地震(8)、Kimi(8)、3.5(8)、深夜(8)、V4(8)、Anthropic(7)、重磅炸弹(7)
...
`pro`、`m3`、`seedance`、`ceo`、`studio`、`app`、`cursor`、`code`、`spud`、`k3`
