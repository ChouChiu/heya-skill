...
1. **超长标题**：平均 52.8 字，80.9% 超过 40 字
2. **情绪炸弹**：大量使用感叹号（21%）和情绪词
3. **多事件合并**：一个标题常包含 2-3 条新闻
4. **AI 日报格式**：61.8% 的标题带 "| AI日报MMDD" 后缀
5. **主导风格**：「情感式」占比 45.5%
6. **独特词汇**：引爆、大地震、重磅、核弹、全面、吓出癫痫、瘫坐、杀疯了、雪崩、头皮发麻
7. **多分句结构**：平均 4.7 个分句，信息密度极高
8. **感叹号密度**：平均每标题 2.1 个感叹号
9. **最常用公式**：`{事件们} | AI日报{日期}`（68次）
10. **交叉风格**：「情感式」含交叉匹配 96 次（87.3%），标题常兼具多种风格
...
大模型诸神之战！Mythos与GPT-5.6呼之欲出！剑拔弩张擦枪走火！硝烟弥漫全网！| AI日报
```
...
**情绪词（必用）**：
引爆、大地震、重磅、核弹、全面、吓出癫痫、瘫坐、杀疯了、雪崩、头皮发麻、海啸、沸腾、硝烟弥漫、命运大转折、史诗级

**AI 领域词**：
AI、模型、DeepSeek、OpenAI、发布、Gemini、GPT、Anthropic、硅谷、泄露、Claude、Kimi、Qwen、上线、MiniMax

**高频词 Top 20**：
AI日报(68)、模型(34)、DeepSeek(30)、AI(22)、OpenAI(21)、AI圈(16)、Gemini(16)、引爆(15)、Anthropic(11)、硅谷(10)、泄露(10)、奥特曼(9)、Mythos(8)、来袭(8)、Kimi(8)、AI圈大地震(8)、Claude(8)、深夜(8)、MiniMax(7)、彻底(7)
...
`agent`、`fable`、`pro`、`seedance`、`ceo`、`lite`、`studio`、`app`、`cursor`、`spud`

**情绪词常用搭配**：

- **引爆** 常搭配：AI圈、AI日报、深夜、核弹、模型
- **大地震** 常搭配：AI圈大地震、AI日报、大地震、Kimi、深夜
- **核弹** 常搭配：核弹、AI圈、AI日报、载入史册、DeepSeek
- **全面** 常搭配：全面、硅谷、AI日报、OpenAI、Anthropic
