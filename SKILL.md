...
1. **超长标题**：平均 51.3 字，74.8% 超过 40 字
2. **情绪炸弹**：大量使用感叹号（24%）和情绪词
3. **多事件合并**：一个标题常包含 2-3 条新闻
4. **AI 日报格式**：58.3% 的标题带 "| AI日报MMDD" 后缀
5. **主导风格**：「情感式」占比 40.9%
6. **独特词汇**：引爆、大地震、核弹、重磅、史诗级、见证历史、头皮发麻、全面、吓出癫痫、雪崩
7. **多分句结构**：平均 4.4 个分句，信息密度极高
8. **感叹号密度**：平均每标题 1.9 个感叹号
9. **最常用公式**：`{事件们} | AI日报{日期}`（67次）
10. **交叉风格**：「情感式」含交叉匹配 96 次（83.5%），标题常兼具多种风格
...
**情绪词（必用）**：
引爆、大地震、核弹、重磅、史诗级、见证历史、头皮发麻、全面、吓出癫痫、雪崩、杀疯了、炸裂、瘫坐、硝烟弥漫、命运大转折

**AI 领域词**：
AI、模型、DeepSeek、OpenAI、发布、Gemini、GPT、Anthropic、硅谷、Qwen、Claude、Google、泄露、Agent、上线

**高频词 Top 20**：
AI日报(66)、模型(32)、DeepSeek(29)、AI(21)、OpenAI(20)、AI圈(16)、引爆(16)、Gemini(16)、Anthropic(12)、硅谷(11)、3.5(10)、来袭(10)、Google(9)、泄露(9)、Claude(9)、奥特曼(8)、Agent(8)、深夜(8)、Mythos(8)、核弹(7)
...
`sonnet`、`fable`、`codex`、`ceo`、`studio`、`app`、`cursor`、`spud`、`siri`、`lite`
...
- **头皮发麻** 常搭配：头皮发麻、AI、DeepSeek、AI日报、Agent
- **重磅** 常搭配：重磅炸弹、AI日报、AI圈大地震、模型、Kimi
- **全面** 常搭配：全面、硅谷、Anthropic、雪崩、AI日报

**风格演变趋势**：

- 标题变长：从 2026-02 的 42.3 字 → 2026-06 的 59.2 字
- 情绪升级：强度从 2 → 5.5
- 最新高频情绪词：引爆
...
- `腾讯今天把饭喂到了嘴边，这只全网最猛的“小龙虾”再不用你就亏大了。`（2次）
