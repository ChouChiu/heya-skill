...
9. **最常用公式**：`{事件们} | AI日报{日期}`（60次）
10. **交叉风格**：「情感式」含交叉匹配 88 次（87.1%），标题常兼具多种风格
...
**AI 领域词**：
AI、DeepSeek、模型、OpenAI、Gemini、发布、GPT、硅谷、Qwen、上线、泄露、Claude、Anthropic、Kimi、Agent

**高频词 Top 20**：
AI日报(60)、模型(33)、DeepSeek(30)、AI(21)、OpenAI(17)、Gemini(16)、AI圈(12)、引爆(12)、硅谷(9)、深夜(8)、泄露(8)、彻底(7)、人类(7)、奥特曼(7)、来袭(7)、AI圈大地震(7)、V4(7)、Claude(7)、GPT(6)、3.5(6)
