...
1. **超长标题**：平均 52.4 字，80.4% 超过 40 字
2. **情绪炸弹**：大量使用感叹号（22%）和情绪词
3. **多事件合并**：一个标题常包含 2-3 条新闻
4. **AI 日报格式**：61.7% 的标题带 "| AI日报MMDD" 后缀
5. **主导风格**：「情感式」占比 44.9%
6. **独特词汇**：大地震、引爆、重磅、吓出癫痫、瘫坐、杀疯了、雪崩、头皮发麻、全面、海啸
7. **多分句结构**：平均 4.7 个分句，信息密度极高
8. **感叹号密度**：平均每标题 2.1 个感叹号
9. **最常用公式**：`{事件们} | AI日报{日期}`（66次）
10. **交叉风格**：「情感式」含交叉匹配 94 次（87.9%），标题常兼具多种风格
...
**情绪词（必用）**：
大地震、引爆、重磅、吓出癫痫、瘫坐、杀疯了、雪崩、头皮发麻、全面、海啸、沸腾、硝烟弥漫、命运大转折、史诗级、斩杀线

**AI 领域词**：
AI、DeepSeek、模型、OpenAI、发布、Gemini、GPT、硅谷、泄露、Claude、Anthropic、Qwen、上线、MiniMax、Kimi

**高频词 Top 20**：
AI日报(66)、模型(33)、DeepSeek(30)、AI(22)、OpenAI(20)、Gemini(16)、AI圈(14)、引爆(13)、硅谷(10)、泄露(10)、奥特曼(9)、Anthropic(8)、AI圈大地震(8)、Claude(8)、深夜(8)、MiniMax(7)、Mythos(7)、Kimi(7)、彻底(7)、人类(7)
...
`agent`、`pro`、`seedance`、`ceo`、`lite`、`studio`、`app`、`cursor`、`code`、`spud`

**情绪词常用搭配**：

- **引爆** 常搭配：深夜、AI圈、AI日报、硅谷、DeepSeek
- **大地震** 常搭配：AI圈大地震、AI日报、大地震、Kimi、深夜
- **重磅** 常搭配：重磅炸弹、AI日报、AI圈大地震、深夜、Kimi
- **头皮发麻** 常搭配：头皮发麻、AI、AI日报、Agent、字节
- **全面** 常搭配：全面、硅谷、AI日报、OpenAI、雪崩
- **沸腾** 常搭配：AI圈、AI日报、DeepSeek、双重、核弹

**风格演变趋势**：

- 标题变长：从 2026-02 的 42.3 字 → 2026-06 的 58.8 字
- 情绪升级：强度从 2 → 5.8
- 最新高频情绪词：大地震
