...
**AI 领域词**：
AI、模型、DeepSeek、OpenAI、Gemini、发布、GPT、泄露、Claude、Qwen、硅谷、上线、Kimi、Anthropic、MiniMax

**高频词 Top 20**：
AI日报(67)、模型(36)、DeepSeek(32)、AI(21)、OpenAI(19)、Gemini(18)、AI圈(12)、引爆(12)、泄露(11)、奥特曼(9)、Claude(9)、硅谷(9)、来袭(9)、AI圈大地震(8)、3.5(8)、深夜(8)、Kimi(7)、Anthropic(7)、彻底(7)、GPT(7)
...
- `苹果投降，{EN}及云服务全盘交由谷歌云托管|{EN}日报{N}月{N}日`（2次）
