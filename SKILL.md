...
1. **超长标题**：平均 52 字，79% 超过 40 字
2. **情绪炸弹**：大量使用感叹号（23%）和情绪词
3. **多事件合并**：一个标题常包含 2-3 条新闻
4. **AI 日报格式**：59% 的标题带 "| AI日报MMDD" 后缀
5. **主导风格**：「情感式」占比 44.0%
6. **独特词汇**：大地震、引爆、杀疯了、吓出癫痫、头皮发麻、全面、海啸、瘫坐、重磅
7. **多分句结构**：平均 4.6 个分句，信息密度极高
8. **感叹号密度**：平均每标题 2.1 个感叹号
9. **最常用公式**：`{事件们} | AI日报{日期}`（59次）
10. **交叉风格**：「情感式」含交叉匹配 87 次（87.0%），标题常兼具多种风格
...
**情绪词（必用）**：
大地震、引爆、杀疯了、吓出癫痫、头皮发麻、全面、海啸、瘫坐、重磅、命运大转折、史诗级、斩杀线、后背发凉、奇点、震撼

**AI 领域词**：
AI、DeepSeek、模型、Gemini、OpenAI、发布、GPT、硅谷、Qwen、上线、泄露、Claude、Anthropic、Kimi、Agent

**高频词 Top 20**：
AI日报(59)、模型(33)、DeepSeek(30)、AI(21)、Gemini(16)、OpenAI(16)、引爆(12)、AI圈(11)、硅谷(9)、深夜(8)、泄露(8)、人类(7)、奥特曼(7)、来袭(7)、AI圈大地震(7)、V4(7)、Claude(7)、GPT(6)、3.5(6)、大地震(6)
