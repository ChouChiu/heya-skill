...
1. **超长标题**：平均 50.8 字，76.4% 超过 40 字
2. **情绪炸弹**：大量使用感叹号（25%）和情绪词
3. **多事件合并**：一个标题常包含 2-3 条新闻
4. **AI 日报格式**：56.2% 的标题带 "| AI日报MMDD" 后缀
5. **主导风格**：「情感式」占比 58.4%
6. **独特词汇**：大地震、引爆、全面、海啸、杀疯了、瘫坐、重磅
...
**悬念式（24.7%）**：
```
OpenAI危！Anthropic 或携  Mythos 1、Opus 4.8、Sonnet 4.8 全线突围！战吗？战啊……！AI终极战争来了！|AI日报
后背发凉！Gemini 神秘功能泄露或在备战I/O？| AI日报0517
已泄露！Gemini 一大波神秘模型即将来袭，谷歌接管世界倒计时？建议把劈柴移交军事法庭！ | AI日报
```
...
**情绪词（必用）**：
大地震、引爆、全面、海啸、杀疯了、瘫坐、重磅、震撼、雪崩、见证历史、疯狂、官宣、斩杀线、硝烟弥漫、史诗级

**AI 领域词**：
AI、DeepSeek、模型、发布、Gemini、OpenAI、GPT、硅谷、Claude、Qwen、Google、Anthropic、开源、算力、多模态

**高频词 Top 20**：
AI(83)、日报(50)、模型(32)、DeepSeek(31)、发布(16)、Gemini(15)、OpenAI(13)、地震(10)、引爆(9)、V4(9)、硅谷(8)、圈大(8)、上线(8)、泄露(8)、即将(7)、来袭(7)、Claude(7)、全线(6)、突围(6)、全球(6)

<!-- AUTO_END:vocab-library -->

<!-- AUTO_START:structure-formulas -->
**公式1：情绪词 + 主题 + 副标题（最常用，58.4%）**
```
{情绪词}！{主题}，{副标题}！
```
