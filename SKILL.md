...
1. **超长标题**：平均 52.2 字，79.4% 超过 40 字
2. **情绪炸弹**：大量使用感叹号（23%）和情绪词
3. **多事件合并**：一个标题常包含 2-3 条新闻
4. **AI 日报格式**：59.8% 的标题带 "| AI日报MMDD" 后缀
5. **主导风格**：「情感式」占比 44.1%
6. **独特词汇**：大地震、引爆、重磅、杀疯了、吓出癫痫、头皮发麻、全面、海啸、瘫坐
7. **多分句结构**：平均 4.6 个分句，信息密度极高
8. **感叹号密度**：平均每标题 2.1 个感叹号
9. **最常用公式**：`{事件们} | AI日报{日期}`（61次）
10. **交叉风格**：「情感式」含交叉匹配 89 次（87.3%），标题常兼具多种风格
...
AI巅峰战！Mythos、GPT 5.6、Gemini 3.5 Pro 互相狙击终极肉搏，人类命运大转折…… | AI日报0604
...
**情绪词（必用）**：
大地震、引爆、重磅、杀疯了、吓出癫痫、头皮发麻、全面、海啸、瘫坐、命运大转折、史诗级、斩杀线、后背发凉、奇点、震撼

**AI 领域词**：
AI、DeepSeek、模型、OpenAI、Gemini、发布、GPT、Claude、泄露、硅谷、Qwen、上线、Anthropic、Kimi、Agent

**高频词 Top 20**：
AI日报(61)、模型(33)、DeepSeek(30)、AI(21)、OpenAI(18)、Gemini(16)、AI圈(12)、引爆(12)、泄露(9)、硅谷(9)、Claude(8)、奥特曼(8)、深夜(8)、彻底(7)、人类(7)、来袭(7)、AI圈大地震(7)、V4(7)、重磅炸弹(6)、GPT(6)
...
`agent`、`pro`、`m3`、`seedance`、`ceo`、`lite`、`chatgpt`、`studio`、`app`、`cursor`

**情绪词常用搭配**：

- **大地震** 常搭配：AI圈大地震、大地震、AI日报、深夜、OpenAI
- **引爆** 常搭配：深夜、AI圈、AI日报、DeepSeek、大地震
- **头皮发麻** 常搭配：头皮发麻、AI、AI日报、Agent、字节
- **全面** 常搭配：全面、硅谷、AI日报、OpenAI、雪崩
- **重磅** 常搭配：重磅炸弹、AI日报、深夜、模型、AI圈大地震
