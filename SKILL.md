...
9. **最常用公式**：`{事件们} | AI日报{日期}`（58次）
10. **交叉风格**：「情感式」含交叉匹配 86 次（86.9%），标题常兼具多种风格
...
**情绪词（必用）**：
大地震、引爆、杀疯了、吓出癫痫、头皮发麻、全面、海啸、瘫坐、重磅、史诗级、斩杀线、后背发凉、奇点、震撼、雪崩

**AI 领域词**：
AI、DeepSeek、模型、OpenAI、发布、Gemini、GPT、硅谷、Qwen、上线、泄露、Claude、Anthropic、Kimi、Agent

**高频词 Top 20**：
AI日报(58)、模型(33)、DeepSeek(30)、AI(20)、OpenAI(16)、Gemini(15)、引爆(12)、AI圈(11)、硅谷(9)、深夜(8)、泄露(8)、奥特曼(7)、来袭(7)、AI圈大地震(7)、V4(7)、Claude(7)、大地震(6)、马斯克(6)、Anthropic(6)、Kimi(6)
...
`agent`、`m3`、`seedance`、`ceo`、`lite`、`chatgpt`、`studio`、`app`、`cursor`、`code`
...
- 标题变长：从 2026-02 的 42.3 字 → 2026-06 的 57 字
- 情绪升级：强度从 2 → 7.3
- 最新高频情绪词：大地震
