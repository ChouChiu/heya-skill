...
1. **超长标题**：平均 51.6 字，77% 超过 40 字
2. **情绪炸弹**：大量使用感叹号（23%）和情绪词
3. **多事件合并**：一个标题常包含 2-3 条新闻
4. **AI 日报格式**：57.4% 的标题带 "| AI日报MMDD" 后缀
5. **主导风格**：「情感式」占比 41.0%
6. **独特词汇**：引爆、大地震、核弹、重磅、史诗级、命运大转折、斩杀线、奇点、瘫坐、全面
7. **多分句结构**：平均 4.3 个分句，信息密度极高
8. **感叹号密度**：平均每标题 1.9 个感叹号
9. **最常用公式**：`{事件们} | AI日报{日期}`（70次）
10. **交叉风格**：「情感式」含交叉匹配 102 次（83.6%），标题常兼具多种风格
...
**情绪词（必用）**：
引爆、大地震、核弹、重磅、史诗级、命运大转折、斩杀线、奇点、瘫坐、全面、吓出癫痫、雪崩、杀疯了、海啸、炸裂

**AI 领域词**：
AI、模型、DeepSeek、OpenAI、发布、Gemini、GPT、Anthropic、Claude、Qwen、硅谷、Google、Kimi、开源、泄露

**高频词 Top 20**：
AI日报(68)、模型(33)、DeepSeek(29)、引爆(22)、AI(22)、OpenAI(21)、AI圈(20)、Gemini(15)、Anthropic(13)、3.5(12)、硅谷(11)、Google(10)、Claude(10)、深夜(10)、核弹(9)、Kimi(9)、开源(9)、V4(9)、AI圈大地震(9)、重磅炸弹(9)
...
`codex`、`ceo`、`studio`、`app`、`spud`、`lmarena`、`kiteki`、`writeclaw`、`pony`、`siri`

**情绪词常用搭配**：

- **引爆** 常搭配：AI圈、AI日报、深夜、核弹、硅谷
...
- 标题变长：从 2026-02 的 42.3 字 → 2026-07 的 51 字
- 情绪升级：强度从 2 → 7
- 最新高频情绪词：引爆

**语料中高频公式模板**：

- `{EN}正式发布{EN}模型，同步推出{EN}{EN}，支持全模态模型统一访问|{EN}日报{N}月...`（2次）
