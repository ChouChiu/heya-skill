...
1. **超长标题**：平均 51.6 字，77.9% 超过 40 字
2. **情绪炸弹**：大量使用感叹号（23%）和情绪词
3. **多事件合并**：一个标题常包含 2-3 条新闻
4. **AI 日报格式**：58.9% 的标题带 "| AI日报MMDD" 后缀
5. **主导风格**：「情感式」占比 44.2%
6. **独特词汇**：大地震、引爆、杀疯了、头皮发麻、全面、海啸、瘫坐、重磅
7. **多分句结构**：平均 4.6 个分句，信息密度极高
8. **感叹号密度**：平均每标题 2.1 个感叹号
9. **最常用公式**：`{事件们} | AI日报{日期}`（56次）
10. **交叉风格**：「情感式」含交叉匹配 82 次（86.3%），标题常兼具多种风格
...
**情绪词（必用）**：
大地震、引爆、杀疯了、头皮发麻、全面、海啸、瘫坐、重磅、后背发凉、奇点、震撼、雪崩、见证历史、吓出癫痫、核弹

**AI 领域词**：
AI、模型、DeepSeek、发布、Gemini、OpenAI、GPT、Qwen、硅谷、上线、泄露、Claude、Anthropic、Kimi、Agent

**高频词 Top 20**：
AI日报(56)、模型(32)、DeepSeek(29)、AI(20)、Gemini(15)、OpenAI(14)、引爆(10)、AI圈(10)、硅谷(8)、泄露(8)、深夜(7)、来袭(7)、AI圈大地震(7)、V4(7)、Claude(7)、Anthropic(6)、Kimi(6)、Agent(6)、彻底(6)、杀疯了(6)
...
`agent`、`ceo`、`lite`、`codex`、`chatgpt`、`studio`、`app`、`cursor`、`code`、`spud`

**情绪词常用搭配**：

- **大地震** 常搭配：AI圈大地震、AI日报、大地震、Kimi、深夜
- **引爆** 常搭配：深夜、AI圈、AI日报、DeepSeek、重磅炸弹
...
- 标题变长：从 2026-02 的 42.3 字 → 2026-05 的 58.4 字
- 情绪升级：强度从 2 → 6.6
- 最新高频情绪词：后背发凉
